...
public final class Assertions {
  ...
  public static <K, V> org.assertj.android.api.util.LruCacheAssert<K, V> assertThat(
      android.util.LruCache<K, V> actual) {
    return new org.assertj.android.api.util.LruCacheAssert<>(actual);
  }

  public static <F, S> org.assertj.android.api.util.PairAssert<F, S> assertThat(
      android.util.Pair<F, S> actual) {
    return new org.assertj.android.api.util.PairAssert<>(actual);
  }

  public static <T, V> org.assertj.android.api.util.PropertyAssert<T, V> assertThat(
      android.util.Property<T, V> actual) {
    return new org.assertj.android.api.util.PropertyAssert<>(actual);
  }

  public static <E> org.assertj.android.api.util.SparseArrayAssert<E> assertThat(
